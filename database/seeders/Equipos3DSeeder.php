...
class Equipos3DSeeder extends Seeder
{
    public function run()
    {
        ...
        $modelos3D = [
            ['nombre' => 'laptop_low-poly', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/laptop_low-poly.glb', 'is_deleted' => false, 'reposo' => 30],
            ['nombre' => 'laptop_alienpredator', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/laptop_alienpredator.glb', 'is_deleted' => false, 'reposo' => 30],
            ['nombre' => 'laptop_windows_menu', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/laptop_windows_menu.glb', 'is_deleted' => false, 'reposo' => 30],
            ['nombre' => 'laptop_dell_g7', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/laptop_dell_g7.glb', 'is_deleted' => false, 'reposo' => 30],
            ['nombre' => 'laptop_acer', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/laptop_acer.glb', 'is_deleted' => false, 'reposo' => 30],

            ['nombre' => 'microfono', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/microfono.glb', 'is_deleted' => false, 'reposo' => 30],
            ['nombre' => 'razer_seiren_x', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/razer_seiren_x.glb', 'is_deleted' => false, 'reposo' => 30],
            ['nombre' => 'skp_pro_40_microphone', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/skp_pro_40_microphone.glb', 'is_deleted' => false, 'reposo' => 30],
            ...
            ['nombre' => 'jbl_speaker', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/jbl_speaker.glb', 'is_deleted' => false, 'reposo' => 30],
            ...
            ['nombre' => 'pc_mouse_type-r', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/pc_mouse_type-r.glb', 'is_deleted' => false, 'reposo' => 30],
            ['nombre' => 'computer_mouse', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/computer_mouse.glb', 'is_deleted' => false, 'reposo' => 30],
            ['nombre' => 'computer_mouse_a4tech_bloody_v7', 'marca_id' => $marcaGen3D->id, 'imagen_glb' => 'models/computer_mouse_a4tech_bloody_v7.glb', 'is_deleted' => false, 'reposo' => 30],
        ];
