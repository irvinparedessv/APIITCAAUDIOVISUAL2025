...
class ReservaRechazoNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Reserva Rechazo')
            ->greeting('Hola ' . $this->reserva->user->first_name)
            ->line('Tu reserva ha sido rechazada.')
            ->line('Detalles:')
    ...
    {
        return [
            'mensaje' => 'Tu reserva ha sido rechazada',
